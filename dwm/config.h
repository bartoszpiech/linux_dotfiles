...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_black, col_violet, col_black },
...
//static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_black, "-nf", col_violet, "-sb", col_green, "-sf", col_black, NULL };
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *browsercmd[] = { "firefox", NULL };
static const char *ytopencmd[] = { "ytopen", NULL };
